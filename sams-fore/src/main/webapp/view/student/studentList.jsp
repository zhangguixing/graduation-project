...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:remoteUrl+"student/studentList&t="+new Date().getTime(),
	        idField:'id', 
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与学生相关的所有数据(包括成绩)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: remoteUrl+"student/deleteStudent",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: remoteUrl+"student/addStudent",
	    ...
	    $("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_photo").attr("src", remoteUrl+"photo/getPhoto&type=2&number="+selectRow.number);
