    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"教学管理",
							"menus":[
									{"menuid":"11","menuname":"成绩查询","icon":"icon-find","url":remoteUrl+"toPage/student/examStudentList.jsp"},
								]
						},
						{"menuid":"2","icon":"","menuname":"班级信息",
							"menus":[
									{"menuid":"21","menuname":"班级通讯录","icon":"icon-note","url":remoteUrl+"toPage/student/studentNoteList.jsp"},
								]
						},
						{"menuid":"3","icon":"","menuname":"系统管理",
							"menus":[
							        {"menuid":"31","menuname":"个人信息","icon":"icon-password","url":remoteUrl+"toPage/student/studentPersonal.jsp"},
								]
						}
				]};
