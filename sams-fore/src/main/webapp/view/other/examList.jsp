...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:remoteUrl+"exam/examList&t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#gradeList").combobox({
	  		...
	  		editable: false, //不可编辑
	  		method: "post",
	  		url: "grade/gradeList&t="+new Date().getTime(),
	  	...
	  	$("#add_gradeList").combobox({
	  		...
	  		editable: false, //不可编辑
	  		method: "post",
	  		url: remoteUrl+"grade/gradeList&t="+new Date().getTime(),
