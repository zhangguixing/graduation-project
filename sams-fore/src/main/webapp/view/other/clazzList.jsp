...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:remoteUrl+"clazz/clazzDetailList&t="+new Date().getTime(),
	        idField:'id', 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与班级相关的所有数据(包括学生)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: remoteUrl+"clazz/deleteClazz",
	  	...
	  	$("#gradeList").combobox({
	  		...
	  		editable: false, //不可编辑
	  		method: "post",
	  		url: remoreUrl+"grade/gradeList&t="+new Date().getTime(),
