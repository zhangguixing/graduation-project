...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src = remoteUrl+"getVCode?t="+new Date().getTime();
		});
		$("#vcodeImg").click();
		//登录
			...
			$.ajax({
				...
				success: function(res){
					...
					if(res.status != 0){
						...
						window.location.href = remodeUrl+"toPage/admin/admin.jsp";
					} else if(res.data == 'student'){
						window.location.href = remodeUrl+"toPage/student/student.jsp";
					} else if(res.data == 'teacher'){
						window.location.href = remodeUrl+"toPage/teacher/teacher.jsp";
					}
				},
				error:function(){
					alert('error');
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src=""></div>
      </div>
...
<div class="footer">Copyright &copy; 河北北方学院 @ 张贵兴 </div>
